...
Analysis of the program's output yields a few key findings. First, trips taken in cities classified as urban account for the vast majority of trips, along with the majority of drivers and fare revenues. Second, fares tend to be lowest in cities classified as urban and highest in cities classified as rural. Third, there appears to be an inverse correlation between the average fare of a city and its ride count. Included below are a few of the program's graphic outputs:
